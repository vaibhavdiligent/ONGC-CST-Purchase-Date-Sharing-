...
*&---------------------------------------------------------------------*
*& Form SEND_EMAIL
*& Send email with HTML body and/or Excel attachment using CL_BCS
*&---------------------------------------------------------------------*
FORM send_email USING pt_emails   TYPE string_table
  ...
  DATA: lv_th TYPE string VALUE
          'style="background:#1a5276;color:#fff;padding:6px 8px;border:1px solid #999;font-size:11px;"',
        lv_td TYPE string VALUE
          'style="padding:4px 8px;border:1px solid #ccc;font-size:11px;"',
        lv_tn TYPE string VALUE
          'style="padding:4px 8px;border:1px solid #ccc;font-size:11px;text-align:right;"'.
  ...
  TRY.
      ...
      IF pv_send_pdf = 'X'.
        ...
        lv_html = '<html><head><meta charset="utf-8"></head>'
               && '<body style="font-family:Arial,sans-serif;margin:20px;">'.

        CONCATENATE lv_html
          '<h2 style="color:#1a5276;">CST Purchase Data - ' s_loc-low
        ...
        " Table header cells with inline styles
        CONCATENATE lv_html '<th ' lv_th '>Gas Day</th>' INTO lv_html.
        CONCATENATE lv_html '<th ' lv_th '>Location</th>' INTO lv_html.
        CONCATENATE lv_html '<th ' lv_th '>Material</th>' INTO lv_html.
        CONCATENATE lv_html '<th ' lv_th '>State Code</th>' INTO lv_html.
        CONCATENATE lv_html '<th ' lv_th '>State</th>' INTO lv_html.
        CONCATENATE lv_html '<th ' lv_th '>CTP ID</th>' INTO lv_html.
        CONCATENATE lv_html '<th ' lv_th '>ONGC Material</th>' INTO lv_html.
        CONCATENATE lv_html '<th ' lv_th '>ONGC ID</th>' INTO lv_html.
        CONCATENATE lv_html '<th ' lv_th '>GCV</th>' INTO lv_html.
        CONCATENATE lv_html '<th ' lv_th '>NCV</th>' INTO lv_html.
        CONCATENATE lv_html '<th ' lv_th '>Qty SCM</th>' INTO lv_html.
        CONCATENATE lv_html '<th ' lv_th '>Qty MBG</th>' INTO lv_html.
        CONCATENATE lv_html '<th ' lv_th '>GAIL ID</th>' INTO lv_html.
        CONCATENATE lv_html '<th ' lv_th '>Tax Type</th></tr>' INTO lv_html.
        ...
        LOOP AT pt_data INTO ls_pur.
          ...
          CONCATENATE lv_html '<td ' lv_td '>' lv_gas_day '</td>' INTO lv_html.
          CONCATENATE lv_html '<td ' lv_td '>' ls_pur-location '</td>' INTO lv_html.
          CONCATENATE lv_html '<td ' lv_td '>' ls_pur-material '</td>' INTO lv_html.
          CONCATENATE lv_html '<td ' lv_td '>' ls_pur-state_code '</td>' INTO lv_html.
          CONCATENATE lv_html '<td ' lv_td '>' ls_pur-state '</td>' INTO lv_html.
          CONCATENATE lv_html '<td ' lv_td '>' ls_pur-ctp '</td>' INTO lv_html.
          CONCATENATE lv_html '<td ' lv_td '>' ls_pur-ongc_mater '</td>' INTO lv_html.
          CONCATENATE lv_html '<td ' lv_td '>' ls_pur-ongc_id '</td>' INTO lv_html.
          CONCATENATE lv_html '<td ' lv_tn '>' lv_gcv '</td>' INTO lv_html.
          CONCATENATE lv_html '<td ' lv_tn '>' lv_ncv '</td>' INTO lv_html.
          CONCATENATE lv_html '<td ' lv_tn '>' lv_qty_scm '</td>' INTO lv_html.
          CONCATENATE lv_html '<td ' lv_tn '>' lv_qty_mbg '</td>' INTO lv_html.
          CONCATENATE lv_html '<td ' lv_td '>' ls_pur-gail_id '</td>' INTO lv_html.
          CONCATENATE lv_html '<td ' lv_td '>' ls_pur-tax_type '</td></tr>' INTO lv_html.
        ENDLOOP.

        CONCATENATE lv_html '</table>'
          '<p style="color:#666;font-size:10px;margin-top:15px;">'
          'Auto-generated email from GAIL GMS System.</p></body></html>'
          INTO lv_html.

        " Split HTML into 255-char lines for soli table
        ...
        WHILE lv_remain > 0.
          ...
          ELSE.
            lv_length = lv_remain.
          ENDIF.
          ls_body-line = lv_html+lv_offset(lv_length).
          APPEND ls_body TO lt_body.
          lv_offset = lv_offset + lv_length.
          lv_remain = lv_remain - lv_length.
        ENDWHILE.

      ELSE.
        " Plain text body when only Excel is selected
        lv_doc_type = 'RAW'.
      ...
      " Create email document with appropriate type (HTM or RAW)
