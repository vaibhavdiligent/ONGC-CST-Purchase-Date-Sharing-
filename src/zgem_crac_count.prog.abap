...
*--- NOTE: CracCount has no confirmed CPI/REST reference in this codebase
...
CONSTANTS: c_dest TYPE rfcdest VALUE 'CPI_HTTP_GEM',
           c_path TYPE string VALUE '/http/GEM/Sync/CracCount'.  " unverified
...
*    to lo_gem_craccount->SI_CRACCOUNT_OB).
ls_request-user     = 'ONGCVIDESH'.
ls_request-method   = 'cracCount'.                        " unverified
...
*wa_orderc-requesttype  = 'CRACCOUNT'.
*wa_orderc-responsecode = |{ lv_code }|.
*wa_orderc-fetchdate    = sy-datum.
