...
*& are hard-coded. Fetched rows are saved to ZGEMC_SDACDET and shown in ALV.
*&---------------------------------------------------------------------*
REPORT zgem_sdac_details.
...
DATA: lo_client   TYPE REF TO if_http_client,
      ...
      lv_item     TYPE posnr,
      it_out      TYPE STANDARD TABLE OF zgemc_sdacdet,
      wa_out      TYPE zgemc_sdacdet,
...
START-OF-SELECTION.
  ...
  LOOP AT ls_response-data INTO ls_sdac.
    ...
    LOOP AT ls_sdac-items INTO ls_item.
      ...
      MODIFY zgemc_sdacdet FROM wa_out.
