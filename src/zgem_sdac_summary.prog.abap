...
*& are hard-coded. Fetched rows are saved to ZGEM_SDACSUMM and shown in ALV.
*&---------------------------------------------------------------------*
REPORT zgem_sdac_summary.
...
DATA: lo_client   TYPE REF TO if_http_client,
      ...
      it_out      TYPE STANDARD TABLE OF zgem_sdacsumm,
      wa_out      TYPE zgem_sdacsumm,
...
START-OF-SELECTION.
  ...
  LOOP AT ls_response-data INTO ls_block.
    LOOP AT ls_block-sdacids INTO ls_sdac.
      ...
      MODIFY zgem_sdacsumm FROM wa_out.
