...
CLASS lcl_tmpl IMPLEMENTATION.
  ...
  METHOD map_3.
    rt = VALUE tt_col(
      ...
      ( tmpl = '67849f38' col = 49  hdr = 'Tax classification for customer' node = 'T' fld = '#1' fmt = '' )
      ( tmpl = '67849f38' col = 50  hdr = 'Tax classification for customer' node = 'T' fld = '#2' fmt = '' )
      ( tmpl = '67849f38' col = 51  hdr = 'Tax classification for customer' node = 'T' fld = '#3' fmt = '' )
      ( tmpl = '67849f38' col = 52  hdr = 'Tax classification for customer' node = 'T' fld = '#4' fmt = '' )
      ( tmpl = '67849f38' col = 53  hdr = 'Tax classification for customer' node = 'T' fld = '#5' fmt = '' )
      ( tmpl = '67849f38' col = 54  hdr = 'Tax classification for customer' node = 'T' fld = '#6' fmt = '' )
    ...
    "  6c94ea65 - 77 columns - IN/ZSHP
      ...
      ( tmpl = '6c94ea65' col = 61  hdr = 'Tax classification for customer' node = 'T' fld = '#1' fmt = '' )
      ( tmpl = '6c94ea65' col = 62  hdr = 'Tax classification for customer' node = 'T' fld = '#2' fmt = '' )
      ( tmpl = '6c94ea65' col = 63  hdr = 'Tax classification for customer' node = 'T' fld = '#3' fmt = '' )
      ( tmpl = '6c94ea65' col = 64  hdr = 'Tax classification for customer' node = 'T' fld = '#4' fmt = '' )
      ( tmpl = '6c94ea65' col = 65  hdr = 'Tax classification for customer' node = 'T' fld = '#5' fmt = '' )
  ...
  METHOD map_5.
    ...
    "  d7ee33bb - 65 columns - UG/ZDOM, UG/ZEXP
      ...
      ( tmpl = 'd7ee33bb' col = 2   hdr = 'Customer code' node = '-' fld = '' fmt = '' )
    ...
    "  da47e4b3 - 76 columns - IN/ZEXP
      ...
      ( tmpl = 'da47e4b3' col = 60  hdr = 'Tax classification for customer' node = 'T' fld = '#1' fmt = '' )
      ( tmpl = 'da47e4b3' col = 61  hdr = 'Tax classification for customer' node = 'T' fld = '#2' fmt = '' )
      ( tmpl = 'da47e4b3' col = 62  hdr = 'Tax classification for customer' node = 'T' fld = '#3' fmt = '' )
      ( tmpl = 'da47e4b3' col = 63  hdr = 'Tax classification for customer' node = 'T' fld = '#4' fmt = '' )
      ( tmpl = 'da47e4b3' col = 64  hdr = 'Tax classification for customer' node = 'T' fld = '#5' fmt = '' )
      ( tmpl = 'da47e4b3' col = 65  hdr = 'Tax classification for customer' node = 'T' fld = '#6' fmt = '' )
