  ...
  LOOP AT ls_response-data INTO ls_order.
    ...
    LOOP AT ls_order-consignmentdetails INTO ls_cons.
      LOOP AT ls_cons-products INTO ls_prod.
        lv_item = lv_item + 1.
        CLEAR wa_out.
        wa_out-gem_invoice_no   = ls_order-geminvoiceno.
        wa_out-item             = lv_item.
        wa_out-order_id         = ls_order-orderid.
        wa_out-bill_no          = ls_order-billno.
        wa_out-bill_date        = ls_order-billdate.
        wa_out-bill_amount      = ls_order-billamount.
        ...
        wa_out-invoice_no       = ls_order-invoiceno.
        wa_out-invoice_date     = ls_order-invoicedate.
  ...
  IF it_out IS NOT INITIAL.
    TRY.
        ...
        lo_alv->get_display_settings( )->set_list_header(
          |GeM Bill Details - { lines( it_out ) } row(s)| ).
        lo_alv->display( ).
