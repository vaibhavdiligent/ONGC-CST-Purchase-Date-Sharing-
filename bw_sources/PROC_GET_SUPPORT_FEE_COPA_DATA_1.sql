CREATE PROCEDURE "CCEJ_VIRTUAL"."ZJ_AccountPL.SupportFee::GET_SUPPORT_FEE_COPA_DATA_1" (IN P_GJAHR NVARCHAR(4) , IN P_FISCPER NVARCHAR(3) ,
IN P_LANGU NVARCHAR(1),
IN P_COMP_CODE NVARCHAR(4) ,  IN P_AC_DOC_TYP NCLOB ,
 IN P_GL_ACCOUNT NCLOB , IN P_CHANNEL NCLOB , IN P_RPPCAT NCLOB , 
...
EJX9005556--GET_SUPPORT_FEE_COPA_DATA_1 3/28/2025
