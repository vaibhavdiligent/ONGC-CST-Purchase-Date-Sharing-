...
*
ssf_id
= 'CN=TEST CLASS IIIB SHATWO, SP=Gujarat, postalCode=392015, OU=CID - 2431135, OU=Marketing, O=Gujarat Narmada Valley Fertilizers Company Limited, C=IN'."wa_ZFI_BATCH_SIGN-ssf_screen.
importing
crc
= crc
signature
