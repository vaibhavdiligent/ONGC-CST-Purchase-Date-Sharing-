*&---------------------------------------------------------------------*
*& Report ZGEM_CPI_ORDER_DETAILS
*&---------------------------------------------------------------------*
*& Get Order Details (3.3) - GeM CPI integration.
...
PARAMETERS:
            ...
            p_path  TYPE string LOWER CASE DEFAULT '/http/GEM/Sync/OrderDetails'.
...
*--- Request payload (Section Get Order Details (3.3))
