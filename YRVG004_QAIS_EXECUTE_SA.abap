*&---------------------------------------------------------------------*
*& Report  YRVG004_QAIS_EXECUTE_SA
*& Title   : CIS Execute (Standalone - No Separate Includes)
*& Based on: YRVG004_QAIS_EXECUTE (extracted from yrvg004_23.pdf)
*&---------------------------------------------------------------------*
REPORT yrvg004_qais_execute_sa MESSAGE-ID yv01.
...
**      IF screen-name = 'R_ANNUAL' OR screen-name = 'R_CONSIS' OR screen-name = 'R_RHD' OR screen-name = 'R_RLLD'." ** SOC Commeneted by Chiluk
...
**  range_s-low = 'K6' .
**  APPEND range_s .
** EOC Commented by Chilukuri Tripura Reddy/Archna/Vishal Charm: 2000001
...
*      IF r_month = 'X' OR r_month1 EQ 'X' OR r_rpd EQ 'X' OR r_rhd EQ 'X' OR r_rlld EQ 'X' or c_maint EQ 'X'." SOC Commented by Chilukuri Tripura Reddy/Archna/Vishal Charm : 4000007222
  IF r_month = 'X' OR r_month1 EQ 'X' OR r_rpd EQ 'X' OR r_rhd EQ 'X' OR r_rlld EQ 'X' OR c_maint EQ 'X' OR c_maint1 EQ 'X' ." SOC by Chilukuri
***EOC by Abhinav/Archna/Vishal on Charm  4000006149, TR DVRK9A112V
** SOC by Chilukuri Tripura Reddy/Archna/Vishal Charm : 4000008707
    IF ls_psdq = 'X'.
